...
<div class="mb-6">
    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-sm font-semibold text-[#0d9488] hover:text-[#0f766e]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12">
        <div class="lg:col-span-5 h-64 lg:h-auto relative bg-gray-100">
            <?php if($lapangan->foto): ?>
                <img class="h-full w-full object-cover" src="<?php echo e(asset('storage/' . $lapangan->foto)); ?>" alt="<?php echo e($lapangan->nama); ?>">
            <?php else: ?>
            ...
            <span class="absolute top-4 left-4 px-3 py-1 rounded-md text-xs font-bold uppercase tracking-wider bg-[#1e3a5f]/90 text-white backdrop-blur-sm">
                <?php echo e(ucfirst($lapangan->tipe)); ?>
        ...
        <div class="lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between">
            <div>
                <div class="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 border-b border-gray-100 pb-4 mb-4">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-extrabold text-[#1e3a5f]"><?php echo e($lapangan->nama); ?></h1>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($lapangan->deskripsi); ?></p>
                </div>
            </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6 mb-6">
        ...
        <form action="<?php echo e(route('lapangan.show', $lapangan->id)); ?>" method="GET" class="flex items-center gap-3">
            <div>
    ...
    <?php if(isset($jadwal_slots) && count($jadwal_slots) > 0): ?>
        <div class="mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <?php $__currentLoopData = $jadwal_slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-4 flex flex-col justify-between transition-all <?php echo e($slot->tersedia ? 'border-gray-200 bg-white hover:border-teal-500 hover:shadow-sm' : 'border-gray-100 bg-gray-50 opacity-75'); ?>">
                        <div class="flex items-center justify-between mb-3">
                            <span class="text-base font-bold <?php echo e($slot->tersedia ? 'text-gray-900' : 'text-gray-400'); ?>">
                                <?php echo e(substr($slot->jam_mulai, 0, 5)); ?> - <?php echo e(substr($slot->jam_selesai, 0, 5)); ?>

                            </span>
                            <?php if($slot->tersedia): ?>
                        ...
                        <div class="text-xs text-gray-500 mb-4">
                            Tarif: <span class="font-semibold text-gray-700">Rp <?php echo e(number_format($lapangan->harga_per_jam, 0, ',', '.')); ?></span>
                        </div>

                        
                        <div>
                            <?php if($slot->tersedia): ?>
                                <a href="<?php echo e(route('booking.create', ['slot_id' => $slot->id])); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rizz\Documents\BookLapang\resources\views/public/show.blade.php ENDPATH**/ ?>